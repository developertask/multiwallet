...
func setupBitcoinPriceFetcher() (BitcoinCashPriceFetcher, func()) {
	...
	return BitcoinCashPriceFetcher{
		cache:     exchangeCache,
		providers: []*ExchangeRateProvider{{url, exchangeCache, &http.Client{}, developertaskDecoder{}}},
...
func TestDecodedevelopertask(t *testing.T) {
	cache := make(map[string]float64)
	openbazaarDecoder := developertaskDecoder{}
